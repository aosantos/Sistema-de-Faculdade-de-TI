  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php }  ?>
              ...
              <div class="container">
  <!-- Modal -->
  <div class="modal fade" id="cadastrar_professor" role="dialog">
        ...
        <div class="modal-header">
          ...
          <form action='<?php echo base_url() ?>add_professor' method='POST' method="get" role="form">
            ...
            <div class="form-group">
              ...
              <input type="text" name="nome_professor"  class="form-control" id="nome_professor" placeholder="Nome do Professor">
            </div>
            <div class="form-group">
              <label for="login_professor"><span class="glyphicon glyphicon-user"></span> Login</label>
              <input type="text" name="login_professor"  class="form-control" id="login_professor" placeholder="Login Temporário do Professor">
            </div>
            <div class="form-group">
              <label for="senha_professor"><span class="glyphicon glyphicon-eye-open"></span> Senha</label>
              <input type="password" name="senha_professor"  class="form-control" id="senha_professor" placeholder="Senha Temporária  do Professor">
            </div>
           ...
           <div class="form-group">
            ...
            <div class="form-group">
              <label for="email_professor"><span class="glyphicon glyphicon-envelope"></span> Email</label>
              <input type="text" name="email_professor" class="form-control" id="email_professor" placeholder="Email">
            </div>
            <div class="form-group">
              <label for="telefone_professor"><span class="glyphicon glyphicon-earphone"></span> Telefone</label>
              <input type="text" name="telefone_professor" class="form-control" id="telefone_professor" placeholder="Telefone">
            </div>
...
<!-- Buttons -->
<button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#cadastrar_professor">Cadastrar Professores</button>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                    $max = count($professor);
                    for ($i = 0; $i < $max; $i++) {
                        $id         = $professor[$i]['idprofessor'];
                        $cod        = $professor[$i]['nome_departamento'];
                        $nome       = $professor[$i]['nome_professor'];
                        $endereco   = $professor[$i]['bairro'];
                        $telefone   = $professor[$i]['telefone_professor'];
                        $email      = $professor[$i]['email_professor'];
                        ?> 
                    
                    <tr class="<?php ?>" id="odd_gradeX_<?= ($i + 1) ?>" data-id="<?= $professor[$i]['idprofessor'] ?>">
                     <td><?= $cod ?></td>
                     <td><?= $nome ?></td>
                     <td><?= $endereco ?></td>
                     <td><?= $telefone ?></td>
...
<!--editar professor-->                         
<!-- Modal -->
  <div class="modal fade" id="editar_professor_<?php echo $professor[$i]['idprofessor']  ?>" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 style="color:green;"><span class="glyphicon glyphicon-lock"></span> Cadastrar Pofessores</h4>
        </div>
          
        <div class="modal-body">
          <form action='<?php echo base_url() ?>editar_professor' method='POST' method="get" role="form">
           ...
           <div class="form-group">
              <label for="nome_professor"><span class="glyphicon glyphicon-sort-by-alphabet"></span> Nome</label>
              <input type="text" name="nome_professor" value="<?php echo $professor[$i]['nome_professor'] ?>" class="form-control" id="nome_professor" placeholder="Nome do Professor">
            </div>
            <div class="form-group">
              <label for="login_diretor"><span class="glyphicon glyphicon-user"></span> Login</label>
              <input type="text" name="login_professor" value="<?php echo $professor[$i]['login_professor'] ?>"  class="form-control" id="login_professor" placeholder="Login Temporário do Professor">
            </div>
            <div class="form-group">
              <label for="senha_professor"><span class="glyphicon glyphicon-eye-open"></span> Senha</label>
              <input type="password" name="senha_professor" value="<?php echo $professor[$i]['senha_professor'] ?>" class="form-control" id="senha_diretor" placeholder="Senha Temporária  do Professor">
            </div>
              <form method="get" action=".">
           <div class="form-group">
              <label for="cep"><span class="glyphicon glyphicon-home"></span> Cep</label>
              <input type="cep" name="cep" value="<?php echo $professor[$i]['cep'] ?>" class="form-control" id="cep" placeholder="Cep">
            </div>  
            <div class="form-group">
              <label for="rua"><span class="glyphicon glyphicon-home"></span> Rua</label>
              <input type="text" name="rua" value="<?php echo $professor[$i]['rua'] ?>" class="form-control" id="rua" placeholder="Rua">
            </div>
            <div class="form-group">
              <label for="bairro"><span class="glyphicon glyphicon-home"></span> Bairro</label>
              <input type="text" name="bairro" value="<?php echo $professor[$i]['bairro'] ?>" class="form-control" id="bairro" placeholder="Bairro">
            </div>
            <div class="form-group">
              <label for="cidade"><span class="glyphicon glyphicon-home"></span> Cidade</label>
              <input type="cidade" name="cidade" value="<?php echo $professor[$i]['cidade'] ?>" class="form-control" id="cidade" placeholder="Cep">
            </div>
             <div class="form-group">
              <label for="estado"><span class="glyphicon glyphicon-home"></span> Estado</label>
              <input type="estado" name="estado" value="<?php echo $professor[$i]['estado'] ?>" class="form-control" id="uf" placeholder="Estado">
            </div> 
            <div class="form-group">
              <label for="numero"><span class="glyphicon glyphicon-sort-by-order"></span> Número</label>
              <input type="text" name="numero" value="<?php echo $professor[$i]['numero'] ?>" class="form-control" id="numero" placeholder="Número">
            </div>
            <div class="form-group">
              <label for="email_professor"><span class="glyphicon glyphicon-envelope"></span> Email</label>
              <input type="text" name="email_professor" value="<?php echo $professor[$i]['email_professor'] ?>" class="form-control" id="email_professor" placeholder="Email">
            </div>
            <div class="form-group">
              <label for="telefone_professor"><span class="glyphicon glyphicon-earphone"></span> Telefone</label>
              <input type="text" name="telefone_professor" value="<?php echo $professor[$i]['telefone_professor'] ?>" class="form-control" id="telefone_professor" placeholder="Telefone">
            </div>
            <button style="color:white;" type="submit" class="btn btn-default btn-success btn-block"><span class="glyphicon glyphicon-plus"></span> Cadastrar</button>
          </form>
        </div>
...
<!--fim do editar professores-->                         
<td>
<button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#editar_professor_<?php echo $professor[$i]['idprofessor'] ?>">
...
<script type="text/javascript" >
    ...
    $(document).ready(function () {
        ...
        remover = function (id) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url() ?>removeProfessor',
                data: {
