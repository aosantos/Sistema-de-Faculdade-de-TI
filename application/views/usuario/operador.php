...
?>  
                ...
                <p>
                  <?= $this->session->userdata('nome_operador') ?>
                </p>
              </li>
...
<!--editar aluno-->                         
<!-- Modal -->
  <div class="modal fade" id="editar_aluno_<?php  $aluno[$i]['idaluno']  ?>" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action='<?php echo base_url() ?>editar_aluno' method='POST' method="get" role="form">
           <input type="hidden" id="idaluno" name="idaluno" value="<?php //$aluno[$i]['idaluno']?>" >
           <div class="form-group">
           ...
           <div class="form-group">
              <label for="nome_aluno"><span class="glyphicon glyphicon-sort-by-alphabet"></span> Nome</label>
              <input type="text" name="nome_aluno" value="<?php // $aluno[$i]['nome_aluno'] ?>" class="form-control" id="nome_aluno" placeholder="Nome do Professor">
            </div>
            <div class="form-group">
              <label for="login_diretor"><span class="glyphicon glyphicon-user"></span> Login</label>
              <input type="text" name="login_aluno" value="<?php // $aluno[$i]['login_aluno'] ?>"  class="form-control" id="login_aluno" placeholder="Login Temporário do Professor">
            </div>
            <div class="form-group">
              <label for="senha_aluno"><span class="glyphicon glyphicon-eye-open"></span> Senha</label>
              <input type="password" name="senha_aluno" value="<?php // $aluno[$i]['senha_aluno'] ?>" class="form-control" id="senha_diretor" placeholder="Senha Temporária  do Professor">
            </div>
              <form method="get" action=".">
           <div class="form-group">
              <label for="cep"><span class="glyphicon glyphicon-home"></span> Cep</label>
              <input type="cep" name="cep" value="<?php // $aluno[$i]['cep'] ?>" class="form-control" id="cep" placeholder="Cep">
            </div>  
            <div class="form-group">
              <label for="rua"><span class="glyphicon glyphicon-home"></span> Rua</label>
              <input type="text" name="rua" value="<?php // $aluno[$i]['rua'] ?>" class="form-control" id="rua" placeholder="Rua">
            </div>
            <div class="form-group">
              <label for="bairro"><span class="glyphicon glyphicon-home"></span> Bairro</label>
              <input type="text" name="bairro" value="<?php // $aluno[$i]['bairro'] ?>" class="form-control" id="bairro" placeholder="Bairro">
            </div>
            <div class="form-group">
              <label for="cidade"><span class="glyphicon glyphicon-home"></span> Cidade</label>
              <input type="cidade" name="cidade" value="<?php // $aluno[$i]['cidade'] ?>" class="form-control" id="cidade" placeholder="Cep">
            </div>
             <div class="form-group">
              <label for="estado"><span class="glyphicon glyphicon-home"></span> Estado</label>
              <input type="estado" name="estado" value="<?php // $aluno[$i]['estado'] ?>" class="form-control" id="uf" placeholder="Estado">
            </div> 
            <div class="form-group">
              <label for="numero"><span class="glyphicon glyphicon-sort-by-order"></span> Número</label>
              <input type="text" name="numero" value="<?php // $aluno[$i]['numero'] ?>" class="form-control" id="numero" placeholder="Número">
            </div>
            <div class="form-group">
              <label for="email_aluno"><span class="glyphicon glyphicon-envelope"></span> Email</label>
              <input type="text" name="email_aluno" value="<?php // $aluno[$i]['email_aluno'] ?>" class="form-control" id="email_aluno" placeholder="Email">
            </div>
            <div class="form-group">
              <label for="telefone_aluno"><span class="glyphicon glyphicon-earphone"></span> Telefone</label>
              <input type="text" name="telefone_aluno" value="<?php // $aluno[$i]['telefone_aluno'] ?>" class="form-control" id="telefone_aluno" placeholder="Telefone">
            </div>
            <button style="color:white;" type="submit" class="btn btn-default btn-success btn-block"><span class="glyphicon glyphicon-plus"></span> Cadastrar</button>
          </form>
        </div>
...
<!--fim do editar alunoes-->                         
<td>
<button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#editar_aluno_<?php  $aluno[$i]['idaluno'] ?>">
