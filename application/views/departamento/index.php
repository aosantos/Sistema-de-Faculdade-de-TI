  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php }  ?>
              ...
              <div class="container">
  <!-- Modal -->
  <div class="modal fade" id="cadastrar_departamento" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 style="color:green;"><span class="glyphicon glyphicon-lock"></span> Cadastrar Departamentos</h4>
        </div>
          
        <div class="modal-body">
          <form action='<?php echo base_url() ?>add_departamento' method='POST' method="get" role="form">
              <form method="get" action=".">
            <div class="form-group">
              <label for="nome_departamento"><span class="glyphicon glyphicon-education"></span> Departamento</label>
              <input type="text" name="nome_departamento" class="form-control" id="nome_departamento" placeholder="Nome do Departamento">
            </div>
...
<!-- Buttons -->
<button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#cadastrar_departamento">Cadastrar Departamentos</button>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                    $max = count($departamento);

                    for ($i = 0; $i < $max; $i++) {

                        $id         = $departamento[$i]['iddepartamento'];
                        $nome       = $departamento[$i]['nome_departamento'];
                        ?> 
                    <tr class="<?php ?>" id="odd_gradeX_<?= ($i + 1) ?>" data-id="<?= $departamento[$i]['iddepartamento'] ?>">
                     <td><?= $nome ?></td>
                         
<!--editar diretor-->                         
<!-- Modal -->
  <div class="modal fade" id="editar_departamento_<?php echo $departamento[$i]['iddepartamento']  ?>" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action='<?php echo base_url() ?>editar_departamento' method='POST' method="get" role="form">
           <input type="hidden" id="iddepartamento" name="iddepartamento" value="<?=$departamento[$i]['iddepartamento']?>" >
              <form method="get" action=".">
            <div class="form-group">
              <label for="nome_departamento"><span class="glyphicon glyphicon-education"></span> Departamento</label>
              <input type="text" name="nome_departamento" value="<?=$nome ?>" class="form-control" id="nome_departamento" placeholder="Departamento">
            </div>
            <button style="color:white;" type="submit" class="btn btn-default btn-success btn-block"><span class="glyphicon glyphicon-plus"></span> Cadastrar</button>
          </form>
        </div>
...
<!--fim do editar departamentos-->                         
<td>
<button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#editar_departamento_<?php echo $departamento[$i]['iddepartamento'] ?>">
...
<script type="text/javascript" >
    ...
    $(document).ready(function () {
        ...
        remover = function (id) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url() ?>removeDepartamento',
                data: {
